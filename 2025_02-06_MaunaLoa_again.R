...
# too monthly average column and deseasonalized column, subtracted them and put it in a new column called seasonal cylce
head(co2)

plot(seasonal_cycle ~ decimal_date,data=co2,type="l")
# plot of seasonal cycle


# SUBSETTING FROM 2020-2025

co2$decimal_date > 2020 
#what rows in the column decimal_date are greater than 2020. This just shows if it's true or false
which(co2$decimal_date > 2020)
# does the same BUT it's returning the indexed position (showing the 743rd row and so on)

#New Data Set: 2020-2025
co2_2020to2025 = co2[co2$decimal_date > 2020, ] 
#we use brackets because we want the rows that meet the criteria and then all the columns
co2_2020to2025
...
## ask about second column in detrended monthly cycle
...
# i is the itnerand or the repetition (the value you're iterating over)
